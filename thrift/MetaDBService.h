...
class MetaDBServiceIf {
 public:
  ...
  virtual void GetEntry(StatInfo& _return, const KeyInfo_THRIFT& key) = 0;
  virtual void PutEntry(const KeyInfo_THRIFT& key, const StatInfo& info) = 0;
  virtual int64_t ReserveNextInodeNo() = 0;
  virtual void GetServerList(std::vector<std::string> & _return) = 0;
  virtual void GetPortList(std::vector<int32_t> & _return) = 0;
};
...
typedef struct _MetaDBService_GetEntry_args__isset {
  _MetaDBService_GetEntry_args__isset() : key(false) {}
  bool key :1;
...
typedef struct _MetaDBService_GetEntry_result__isset {
  _MetaDBService_GetEntry_result__isset() : success(false), unknown_dir(false), srv_redirect(false), not_found(false), io_error(false), srv_error(false) {}
  bool success :1;
  bool unknown_dir :1;
  bool srv_redirect :1;
  bool not_found :1;
...
typedef struct _MetaDBService_GetEntry_presult__isset {
  _MetaDBService_GetEntry_presult__isset() : success(false), unknown_dir(false), srv_redirect(false), not_found(false), io_error(false), srv_error(false) {}
  bool success :1;
  bool unknown_dir :1;
  bool srv_redirect :1;
  bool not_found :1;
...
typedef struct _MetaDBService_PutEntry_args__isset {
  _MetaDBService_PutEntry_args__isset() : key(false), info(false) {}
  bool key :1;
  bool info :1;
} _MetaDBService_PutEntry_args__isset;

class MetaDBService_PutEntry_args {
 public:

  MetaDBService_PutEntry_args(const MetaDBService_PutEntry_args&);
  MetaDBService_PutEntry_args& operator=(const MetaDBService_PutEntry_args&);
  MetaDBService_PutEntry_args() {
  }

  virtual ~MetaDBService_PutEntry_args() throw();
  KeyInfo_THRIFT key;
  StatInfo info;

  _MetaDBService_PutEntry_args__isset __isset;

  void __set_key(const KeyInfo_THRIFT& val);

  void __set_info(const StatInfo& val);

  bool operator == (const MetaDBService_PutEntry_args & rhs) const
  {
    if (!(key == rhs.key))
      return false;
    if (!(info == rhs.info))
  ...
  bool operator < (const MetaDBService_PutEntry_args & ) const;
...
class MetaDBService_PutEntry_pargs {
 public:


  virtual ~MetaDBService_PutEntry_pargs() throw();
  const KeyInfo_THRIFT* key;
  const StatInfo* info;
...
typedef struct _MetaDBService_PutEntry_result__isset {
  _MetaDBService_PutEntry_result__isset() : unknown_dir(false), srv_redirect(false), file_exists(false), io_error(false), srv_error(false) {}
  bool unknown_dir :1;
  bool srv_redirect :1;
  bool file_exists :1;
  bool io_error :1;
  bool srv_error :1;
} _MetaDBService_PutEntry_result__isset;

class MetaDBService_PutEntry_result {
 public:

  MetaDBService_PutEntry_result(const MetaDBService_PutEntry_result&);
  MetaDBService_PutEntry_result& operator=(const MetaDBService_PutEntry_result&);
  MetaDBService_PutEntry_result() {
  }

  virtual ~MetaDBService_PutEntry_result() throw();
  UnrecognizedDirectoryError unknown_dir;
  ServerRedirectionException srv_redirect;
  FileAlreadyExistsException file_exists;
  IOError io_error;
  ...
  _MetaDBService_PutEntry_result__isset __isset;
  ...
  bool operator == (const MetaDBService_PutEntry_result & rhs) const
  {
    if (!(unknown_dir == rhs.unknown_dir))
      return false;
    if (!(srv_redirect == rhs.srv_redirect))
  ...
  bool operator < (const MetaDBService_PutEntry_result & ) const;
...
typedef struct _MetaDBService_PutEntry_presult__isset {
  _MetaDBService_PutEntry_presult__isset() : unknown_dir(false), srv_redirect(false), file_exists(false), io_error(false), srv_error(false) {}
  bool unknown_dir :1;
  bool srv_redirect :1;
  bool file_exists :1;
  bool io_error :1;
  bool srv_error :1;
} _MetaDBService_PutEntry_presult__isset;

class MetaDBService_PutEntry_presult {
 public:


  virtual ~MetaDBService_PutEntry_presult() throw();
  UnrecognizedDirectoryError unknown_dir;
  ServerRedirectionException srv_redirect;
  FileAlreadyExistsException file_exists;
  IOError io_error;
  ...
  _MetaDBService_PutEntry_presult__isset __isset;
...
class MetaDBService_ReserveNextInodeNo_args {
 public:

  MetaDBService_ReserveNextInodeNo_args(const MetaDBService_ReserveNextInodeNo_args&);
  MetaDBService_ReserveNextInodeNo_args& operator=(const MetaDBService_ReserveNextInodeNo_args&);
  MetaDBService_ReserveNextInodeNo_args() {
  }

  virtual ~MetaDBService_ReserveNextInodeNo_args() throw();

  bool operator == (const MetaDBService_ReserveNextInodeNo_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const MetaDBService_ReserveNextInodeNo_args &rhs) const {
  ...
  bool operator < (const MetaDBService_ReserveNextInodeNo_args & ) const;
...
class MetaDBService_ReserveNextInodeNo_pargs {
 public:


  virtual ~MetaDBService_ReserveNextInodeNo_pargs() throw();

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _MetaDBService_ReserveNextInodeNo_result__isset {
  _MetaDBService_ReserveNextInodeNo_result__isset() : success(false), io_error(false), srv_error(false) {}
  bool success :1;
  bool io_error :1;
  bool srv_error :1;
} _MetaDBService_ReserveNextInodeNo_result__isset;

class MetaDBService_ReserveNextInodeNo_result {
 public:

  MetaDBService_ReserveNextInodeNo_result(const MetaDBService_ReserveNextInodeNo_result&);
  MetaDBService_ReserveNextInodeNo_result& operator=(const MetaDBService_ReserveNextInodeNo_result&);
  MetaDBService_ReserveNextInodeNo_result() : success(0) {
  }

  virtual ~MetaDBService_ReserveNextInodeNo_result() throw();
  int64_t success;
  IOError io_error;
  ServerInternalError srv_error;

  _MetaDBService_ReserveNextInodeNo_result__isset __isset;
  ...
  bool operator == (const MetaDBService_ReserveNextInodeNo_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(io_error == rhs.io_error))
  ...
  bool operator < (const MetaDBService_ReserveNextInodeNo_result & ) const;
...
typedef struct _MetaDBService_ReserveNextInodeNo_presult__isset {
  _MetaDBService_ReserveNextInodeNo_presult__isset() : success(false), io_error(false), srv_error(false) {}
  bool success :1;
  bool io_error :1;
  bool srv_error :1;
} _MetaDBService_ReserveNextInodeNo_presult__isset;

class MetaDBService_ReserveNextInodeNo_presult {
 public:


  virtual ~MetaDBService_ReserveNextInodeNo_presult() throw();
  int64_t* success;
  IOError io_error;
  ServerInternalError srv_error;

  _MetaDBService_ReserveNextInodeNo_presult__isset __isset;
...
class MetaDBService_GetPortList_args {
 public:

  MetaDBService_GetPortList_args(const MetaDBService_GetPortList_args&);
  MetaDBService_GetPortList_args& operator=(const MetaDBService_GetPortList_args&);
  MetaDBService_GetPortList_args() {
  }

  virtual ~MetaDBService_GetPortList_args() throw();

  bool operator == (const MetaDBService_GetPortList_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const MetaDBService_GetPortList_args &rhs) const {
  ...
  bool operator < (const MetaDBService_GetPortList_args & ) const;
...
class MetaDBService_GetPortList_pargs {
 public:


  virtual ~MetaDBService_GetPortList_pargs() throw();

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _MetaDBService_GetPortList_result__isset {
  _MetaDBService_GetPortList_result__isset() : success(false), srv_error(false) {}
  bool success :1;
  bool srv_error :1;
} _MetaDBService_GetPortList_result__isset;

class MetaDBService_GetPortList_result {
 public:

  MetaDBService_GetPortList_result(const MetaDBService_GetPortList_result&);
  MetaDBService_GetPortList_result& operator=(const MetaDBService_GetPortList_result&);
  MetaDBService_GetPortList_result() {
  }

  virtual ~MetaDBService_GetPortList_result() throw();
  std::vector<int32_t>  success;
  ServerInternalError srv_error;

  _MetaDBService_GetPortList_result__isset __isset;

  void __set_success(const std::vector<int32_t> & val);

  void __set_srv_error(const ServerInternalError& val);

  bool operator == (const MetaDBService_GetPortList_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(srv_error == rhs.srv_error))
  ...
  bool operator < (const MetaDBService_GetPortList_result & ) const;
...
typedef struct _MetaDBService_GetPortList_presult__isset {
  _MetaDBService_GetPortList_presult__isset() : success(false), srv_error(false) {}
  bool success :1;
  bool srv_error :1;
} _MetaDBService_GetPortList_presult__isset;

class MetaDBService_GetPortList_presult {
 public:


  virtual ~MetaDBService_GetPortList_presult() throw();
  std::vector<int32_t> * success;
  ServerInternalError srv_error;

  _MetaDBService_GetPortList_presult__isset __isset;
...
class MetaDBServiceClient : virtual public MetaDBServiceIf {
 ...
 public:
  ...
  void GetEntry(StatInfo& _return, const KeyInfo_THRIFT& key);
  void send_GetEntry(const KeyInfo_THRIFT& key);
  void recv_GetEntry(StatInfo& _return);
  void PutEntry(const KeyInfo_THRIFT& key, const StatInfo& info);
  void send_PutEntry(const KeyInfo_THRIFT& key, const StatInfo& info);
  void recv_PutEntry();
  int64_t ReserveNextInodeNo();
  void send_ReserveNextInodeNo();
  int64_t recv_ReserveNextInodeNo();
  void GetServerList(std::vector<std::string> & _return);
  void send_GetServerList();
  void recv_GetServerList(std::vector<std::string> & _return);
  void GetPortList(std::vector<int32_t> & _return);
  void send_GetPortList();
  void recv_GetPortList(std::vector<int32_t> & _return);
 protected:
...
class MetaDBServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_PutEntry(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_ReserveNextInodeNo(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_GetPortList(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  MetaDBServiceProcessor(boost::shared_ptr<MetaDBServiceIf> iface) :
    ...
    processMap_["PutEntry"] = &MetaDBServiceProcessor::process_PutEntry;
    processMap_["ReserveNextInodeNo"] = &MetaDBServiceProcessor::process_ReserveNextInodeNo;
    processMap_["GetServerList"] = &MetaDBServiceProcessor::process_GetServerList;
    processMap_["GetPortList"] = &MetaDBServiceProcessor::process_GetPortList;
  }
...
class MetaDBServiceMultiface : virtual public MetaDBServiceIf {
 ...
 public:
  ...
  void GetEntry(StatInfo& _return, const KeyInfo_THRIFT& key) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetEntry(_return, key);
    }
    ifaces_[i]->GetEntry(_return, key);
    return;
  }
  ...
  int64_t ReserveNextInodeNo() {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ReserveNextInodeNo();
    }
    return ifaces_[i]->ReserveNextInodeNo();
  }
...
class MetaDBServiceConcurrentClient : virtual public MetaDBServiceIf {
 ...
 public:
  ...
  void GetEntry(StatInfo& _return, const KeyInfo_THRIFT& key);
  int32_t send_GetEntry(const KeyInfo_THRIFT& key);
  void recv_GetEntry(StatInfo& _return, const int32_t seqid);
  void PutEntry(const KeyInfo_THRIFT& key, const StatInfo& info);
  int32_t send_PutEntry(const KeyInfo_THRIFT& key, const StatInfo& info);
  void recv_PutEntry(const int32_t seqid);
  int64_t ReserveNextInodeNo();
  int32_t send_ReserveNextInodeNo();
  int64_t recv_ReserveNextInodeNo(const int32_t seqid);
  void GetServerList(std::vector<std::string> & _return);
  int32_t send_GetServerList();
  void recv_GetServerList(std::vector<std::string> & _return, const int32_t seqid);
  void GetPortList(std::vector<int32_t> & _return);
  int32_t send_GetPortList();
  void recv_GetPortList(std::vector<int32_t> & _return, const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
