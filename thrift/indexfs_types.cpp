...
KeyInfo_THRIFT::~KeyInfo_THRIFT() throw() {
}


void KeyInfo_THRIFT::__set_parent_id_(const int64_t val) {
  this->parent_id_ = val;
}

void KeyInfo_THRIFT::__set_partition_id_(const int16_t val) {
  this->partition_id_ = val;
}

void KeyInfo_THRIFT::__set_file_name_(const std::string& val) {
  this->file_name_ = val;
}

uint32_t KeyInfo_THRIFT::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  bool isset_parent_id_ = false;
  bool isset_partition_id_ = false;
  bool isset_file_name_ = false;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->parent_id_);
          isset_parent_id_ = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I16) {
          xfer += iprot->readI16(this->partition_id_);
          isset_partition_id_ = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->file_name_);
          isset_file_name_ = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t KeyInfo_THRIFT::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("KeyInfo_THRIFT");

  xfer += oprot->writeFieldBegin("parent_id_", ::apache::thrift::protocol::T_I64, 1);
  xfer += oprot->writeI64(this->parent_id_);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("partition_id_", ::apache::thrift::protocol::T_I16, 2);
  xfer += oprot->writeI16(this->partition_id_);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("file_name_", ::apache::thrift::protocol::T_STRING, 3);
  xfer += oprot->writeString(this->file_name_);
  xfer += oprot->writeFieldEnd();
...
void swap(KeyInfo_THRIFT &a, KeyInfo_THRIFT &b) {
  using ::std::swap;
  swap(a.parent_id_, b.parent_id_);
  swap(a.partition_id_, b.partition_id_);
  swap(a.file_name_, b.file_name_);
}

KeyInfo_THRIFT::KeyInfo_THRIFT(const KeyInfo_THRIFT& other50) {
  parent_id_ = other50.parent_id_;
  partition_id_ = other50.partition_id_;
  file_name_ = other50.file_name_;
}
KeyInfo_THRIFT& KeyInfo_THRIFT::operator=(const KeyInfo_THRIFT& other51) {
  parent_id_ = other51.parent_id_;
  partition_id_ = other51.partition_id_;
  file_name_ = other51.file_name_;
  return *this;
}
void KeyInfo_THRIFT::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "KeyInfo_THRIFT(";
  out << "parent_id_=" << to_string(parent_id_);
  out << ", " << "partition_id_=" << to_string(partition_id_);
  out << ", " << "file_name_=" << to_string(file_name_);
  out << ")";
}
...
FileNotFoundException::FileNotFoundException(const FileNotFoundException& other52) : TException() {
  (void) other52;
}
FileNotFoundException& FileNotFoundException::operator=(const FileNotFoundException& other53) {
  (void) other53;
  return *this;
}
...
FileAlreadyExistsException::FileAlreadyExistsException(const FileAlreadyExistsException& other54) : TException() {
  (void) other54;
}
FileAlreadyExistsException& FileAlreadyExistsException::operator=(const FileAlreadyExistsException& other55) {
  (void) other55;
  return *this;
}
...
UnrecognizedDirectoryError::UnrecognizedDirectoryError(const UnrecognizedDirectoryError& other56) : TException() {
  (void) other56;
}
UnrecognizedDirectoryError& UnrecognizedDirectoryError::operator=(const UnrecognizedDirectoryError& other57) {
  (void) other57;
  return *this;
}
...
WrongServerError::WrongServerError(const WrongServerError& other58) : TException() {
  (void) other58;
}
WrongServerError& WrongServerError::operator=(const WrongServerError& other59) {
  (void) other59;
  return *this;
}
...
DirectoryExpectedError::DirectoryExpectedError(const DirectoryExpectedError& other60) : TException() {
  (void) other60;
}
DirectoryExpectedError& DirectoryExpectedError::operator=(const DirectoryExpectedError& other61) {
  (void) other61;
  return *this;
}
...
FileExpectedError::FileExpectedError(const FileExpectedError& other62) : TException() {
  (void) other62;
}
FileExpectedError& FileExpectedError::operator=(const FileExpectedError& other63) {
  (void) other63;
  return *this;
}
...
IOError::IOError(const IOError& other64) : TException() {
  message = other64.message;
}
IOError& IOError::operator=(const IOError& other65) {
...
ServerInternalError::ServerInternalError(const ServerInternalError& other66) : TException() {
  message = other66.message;
}
ServerInternalError& ServerInternalError::operator=(const ServerInternalError& other67) {
...
IllegalPathException::IllegalPathException(const IllegalPathException& other68) : TException() {
  (void) other68;
}
IllegalPathException& IllegalPathException::operator=(const IllegalPathException& other69) {
  (void) other69;
  return *this;
}
...
ServerRedirectionException::ServerRedirectionException(const ServerRedirectionException& other70) : TException() {
  dmap_data = other70.dmap_data;
}
ServerRedirectionException& ServerRedirectionException::operator=(const ServerRedirectionException& other71) {
  dmap_data = other71.dmap_data;
  return *this;
}
...
ParentPathNotFoundException::ParentPathNotFoundException(const ParentPathNotFoundException& other72) : TException() {
  parent_path = other72.parent_path;
}
ParentPathNotFoundException& ParentPathNotFoundException::operator=(const ParentPathNotFoundException& other73) {
...
ParentPathNotDirectoryException::ParentPathNotDirectoryException(const ParentPathNotDirectoryException& other74) : TException() {
  parent_path = other74.parent_path;
}
ParentPathNotDirectoryException& ParentPathNotDirectoryException::operator=(const ParentPathNotDirectoryException& other75) {
  parent_path = other75.parent_path;
  return *this;
}
