...
class CliRep_MetaDB {
  ...
  // No copying allowed
  CliRep_MetaDB(const CliRep_MetaDB&);
  CliRep_MetaDB& operator=(const CliRep_MetaDB&);
 ...
 public:
  ...
  CliRep_MetaDB(const std::string& ip, int port)
...
//
class FTCliRepWrapper_MetaDB: virtual public MetaDBServiceIf {

  // No copying allowed
  FTCliRepWrapper_MetaDB(const FTCliRepWrapper_MetaDB&);
  FTCliRepWrapper_MetaDB& operator=(const FTCliRepWrapper_MetaDB&);

  CliRep_MetaDB* client_; // the real client being adapted
  int metadb_id_;
  Config* conf_;
  Env* env_;
 ...
 public:
  ...
  virtual ~FTCliRepWrapper_MetaDB();
  FTCliRepWrapper_MetaDB(int metadb_id, Config* conf, MemberSet* member_set);
