...
public class ScanResult implements org.apache.thrift.TBase<ScanResult, ScanResult._Fields>, java.io.Serializable, Cloneable, Comparable<ScanResult> {
  ...
  private static final org.apache.thrift.protocol.TField END_PARTITION_FIELD_DESC = new org.apache.thrift.protocol.TField("end_partition", org.apache.thrift.protocol.TType.I16, (short)3);
  private static final org.apache.thrift.protocol.TField MORE_ENTRIES_FIELD_DESC = new org.apache.thrift.protocol.TField("more_entries", org.apache.thrift.protocol.TType.I16, (short)4);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    END_PARTITION((short)3, "end_partition"),
    MORE_ENTRIES((short)4, "more_entries"),
  ...
  public ScanResult setEntries(List<String> entries) {
    this.entries = entries;
    return this;
  }
  ...
  public ScanResult setEnd_key(String end_key) {
    this.end_key = end_key;
    return this;
  }
  ...
  public ScanResult setEnd_partition(short end_partition) {
    this.end_partition = end_partition;
    setEnd_partitionIsSet(true);
    return this;
  }
  ...
  public ScanResult setMore_entries(short more_entries) {
    this.more_entries = more_entries;
    setMore_entriesIsSet(true);
    return this;
  }
  ...
  public ScanResult setDmap_data(String dmap_data) {
    this.dmap_data = dmap_data;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.entries = new ArrayList<String>(_list16.size);
                String _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = iprot.readString();
                  struct.entries.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScanResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.entries != null) {
        oprot.writeFieldBegin(ENTRIES_FIELD_DESC);
        {
          ...
          for (String _iter19 : struct.entries)
          {
  ...
  private static class ScanResultTupleScheme extends TupleScheme<ScanResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ScanResult struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (String _iter20 : struct.entries)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ScanResult struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.entries = new ArrayList<String>(_list21.size);
        String _elem22;
        for (int _i23 = 0; _i23 < _list21.size; ++_i23)
        {
          _elem22 = iprot.readString();
          struct.entries.add(_elem22);
        }
      }
      struct.setEntriesIsSet(true);
      struct.end_key = iprot.readString();
