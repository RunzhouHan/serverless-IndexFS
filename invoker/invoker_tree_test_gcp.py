...
def first_request(serverless_function_url, deployment_id, num_of_deployment):
        ...
        PARAMS = {'zeroth_server':'146.148.61.223', 'zeroth_port':10086, 'instance_id':0, 'deployment_id':deployment_id, 'deployment_num':num_of_deployment, 'outToClient_intop_type': 'Mknod', 'path':file_path, 'OID': OID, 'client_ip': '146.148.61.223', 'client_port':2004, 'client_num':1};
